...
module Submissions
  module GenerateAuditTrail
    ...
    def call(submission)
      ...
      document.trailer.info[:Creator] = "#{Uvtsign.product_name} (#{Uvtsign::PRODUCT_URL})"
    ...
    def build_audit_trail(submission)
      account = submission.account
      verify_url = Rails.application.routes.url_helpers.settings_esign_url(**Uvtsign.default_url_options)
      page_size =
    ...
    def add_logo(column, _submission = nil)
      ...
      column.formatted_text([{ text: 'UVTSign',
                               link: Uvtsign::PRODUCT_URL }],
                            font_size: 20,
                            font: [FONT_NAME, { variant: :bold }],
                            width: 100,
                            padding: [5, 0, 0, 8],
